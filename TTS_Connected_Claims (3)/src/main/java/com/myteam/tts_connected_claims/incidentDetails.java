...
public class incidentDetails implements java.io.Serializable {
	...
	@org.kie.api.definition.type.Label(value = "thirdPartyCount")
	private java.lang.Integer thirdPartyCount;
	...
	public java.lang.Integer getThirdPartyCount() {
		return this.thirdPartyCount;
	}

	public void setThirdPartyCount(java.lang.Integer thirdPartyCount) {
	...
	public incidentDetails(
			...
			java.lang.String otherIncidentDriverName,
			com.myteam.tts_connected_claims.location incidentLocation,
			java.lang.Integer thirdPartyCount) {
		this.incidentTime = incidentTime;
		this.location = location;
		this.description = description;
		this.triggerSource = triggerSource;
